...
def tile_joint_matrix_fragment(block_read):
...
tile_joint_matrix_fragment(A_joint)
tile_joint_matrix_fragment(B_joint)

# sch.tensorize(tile_joint_matrix_fragment(A_joint), "joint_matrix_load_a")
# sch.tensorize(tile_joint_matrix_fragment(B_joint), "joint_matrix_load_b")
