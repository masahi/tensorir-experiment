...
sch.annotate(block_or_loop=b20, ann_key="meta_schedule.auto_tensorize", ann_val=MMA_f16f16f32_INTRIN)
sch.annotate(block_or_loop=b20, ann_key="meta_schedule.auto_tensorize_init", ann_val=MMA_fill_16x16_f32_INTRIN)
...
sch.annotate(block_or_loop=b72, ann_key="meta_schedule.auto_tensorize", ann_val=MMA_store_16x16_f32_shared_INTRIN)
sch.transform_layout(b54, ("read", 0), index_map)
...
b91 = sch.cache_read(block=b20, read_buffer_index=0, storage_scope="warp")
...
sch.annotate(block_or_loop=b112, ann_key="meta_schedule.auto_tensorize", ann_val=LDMATRIX_16x16_A_INTRIN)
sch.transform_layout(b91, ("write", 0), index_map)

b113 = sch.cache_read(block=b20, read_buffer_index=1, storage_scope="warp")
...
sch.annotate(block_or_loop=b134, ann_key="meta_schedule.auto_tensorize", ann_val=LDMATRIX_16x16_B_INTRIN)
sch.transform_layout(b113, ("write", 0), index_map)
...
sch.annotate(block_or_loop=b231, ann_key="meta_schedule.auto_tensorize", ann_val=MMA_fill_16x16_f32_INTRIN)
...
sch.tensorize(block_or_loop=b232, tensor_intrin=MMA_fill_16x16_f32_INTRIN)

b233 = sch.get_block(name="A_reindex_shared_warp_o", func_name="main")
sch.unannotate(block_or_loop=b233, ann_key="meta_schedule.auto_tensorize")
sch.tensorize(block_or_loop=b233, tensor_intrin=LDMATRIX_16x16_A_INTRIN)

b234 = sch.get_block(name="B_reindex_shared_warp_o", func_name="main")
sch.unannotate(block_or_loop=b234, ann_key="meta_schedule.auto_tensorize")
sch.tensorize(block_or_loop=b234, tensor_intrin=LDMATRIX_16x16_B_INTRIN)

b235 = sch.get_block(name="C_o_update", func_name="main")
sch.unannotate(block_or_loop=b235, ann_key="meta_schedule.auto_tensorize")
sch.tensorize(block_or_loop=b235, tensor_intrin=MMA_f16f16f32_INTRIN)

b236 = sch.get_block(name="C_reindex_shared_warp_o", func_name="main")
sch.unannotate(block_or_loop=b236, ann_key="meta_schedule.auto_tensorize")
sch.tensorize(block_or_loop=b236, tensor_intrin=MMA_store_16x16_f32_shared_INTRIN)
